...
const post_10_desc = "一款基于Vite和Vue3编写的轻量级博客框架，旨在使用Markdown这门简介的文档语言构建和编写博客文章。";
...
export default {
    ...
    actives: [
        ...
        { path: "post-8", config: { path: "post-8", name: '好久不见，分享一些我的个人原创小作品', desc: post_8_desc, image: post_8, tags: ['我的项目','个人原创','原创作品','日常小记'], class: ['我的项目','个人原创','原创作品','日常小记'] }, isFixed: false },
        ...
        { path: "post-10", config: { path: "post-10", name: 'Markblog - 一款Vue3轻量级博客框架', desc: post_10_desc, image: background, tags: ['我的项目','个人原创','原创作品'], class: ['我的项目','个人原创','原创作品'] }, isFixed: true },
    ],
    author: {
        author_name: '麻辣猪头',
    ...
    carousel: [
        { title: 'Markblog - 一款Vue3轻量级博客框架', desc: post_10_desc, image: background, href: '/docs/post-10' },
        { title: '叮！来自王健铮的 2023 年度总结', desc: post_9_desc, image: post_9, href: '/docs/post-9' },
        { title: '好久不见，分享一些我的个人原创小作品', desc: post_8_desc, image: post_8, href: '/docs/post-8' },
        { title: '自制运维工具箱，再也不用担心记不住命令了', desc: post_7_desc, image: post_7, href: '/docs/post-7' },
    ]
}